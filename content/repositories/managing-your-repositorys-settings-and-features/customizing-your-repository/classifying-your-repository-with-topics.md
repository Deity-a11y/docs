...
{% ifversion fpt or ghec %}You can contribute to {% data variables.product.github %}'s set of featured topics in the [github/explore](https://github.com/github/explore) repository. {% endif %}
